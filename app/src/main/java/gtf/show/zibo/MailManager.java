...
public class MailManager {
	...
	private static final String SENDER_TO = "gtf35test@163.com";
    private static final String SENDER_PASS = "xxdebugTest";
    ...
    private MimeMessage createMessage(String title, String content) {
        ...
        try {
            ...
            InternetAddress[] addresses = new InternetAddress[]{new InternetAddress(SENDER_TO)};
